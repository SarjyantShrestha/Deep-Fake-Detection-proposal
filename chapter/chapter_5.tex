\chapter{Work Completed}
	...
	\end{equation}
	\begin{equation}
		\text{Recall} = \frac{\text{True Positive}}{\text{True Positive} + \text{False Negative}} = \frac{\text{1762}}{\text{1762} + \text{238}} = \text{0.938}
	\end{equation}
	\begin{equation}
	...
	\begin{table}[h]
		...
		\textbf{Fake} & 0.95 & 0.96 & 0.96 & 5000 \\
		\textbf{Real} & 0.90 & 0.88 & 0.89 & 2000 \\
		\textbf{Accuracy} & \multicolumn{4}{c}{0.94} \\
		\textbf{Macro Avg} & 0.93 & 0.92 & 0.92 & 7000 \\
		\textbf{Weighted Avg} & 0.94 & 0.94 & 0.94 & 7000 \\ 
		\multicolumn{5}{c}{\textbf{}} \\
		\multicolumn{5}{c}{\textbf{}} \\
		\end{tabular}
	  \end{table}